...
- 2025-02-20：v0.1.0 修复telegram的URL有效期失效bug
- 2025-04-11：v0.1.1 新增从剪贴板上传图片功能
- 2025-05-21：v0.1.2 性能优化
- 2025-05-22：v0.1.3 新增RESTful API接口和命令行客户端
- 2025-06-29：v0.1.4 修复WebP识别问题
- 2025-10-14：v0.1.5 新增缩略图功能
- 2025-12-07：v0.1.6 新增登录上传限制功能
- 2025-12-07：v0.1.7 新增CORS支持
- 2026-01-06：v0.1.8 优化代码
- 2026-02-15：v0.1.9 修复relogin bug
- 2026-03-22：v0.2.0 新增文档文件支持、多线程上传优化、完善打包流程
